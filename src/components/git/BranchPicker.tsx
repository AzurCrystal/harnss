        ...
        <div className="absolute left-0 right-0 top-full z-50 mt-1 max-h-72 overflow-y-auto rounded-lg border border-foreground/[0.1] bg-[var(--background)] shadow-xl">
          ...
          {localBranches.length > 0 && (
            <div className="py-0.5">
              <div className="px-3 pt-1.5 pb-0.5 text-[9px] font-semibold uppercase tracking-widest text-foreground/30">本地</div>
              {localBranches.map((b) => (
          ...
          {remoteBranches.length > 0 && (
            <div className="border-t border-foreground/[0.06] py-0.5">
              <div className="px-3 pt-1.5 pb-0.5 text-[9px] font-semibold uppercase tracking-widest text-foreground/30">远程</div>
          ...
          {filteredBranches.length === 0 && (
            <div className="px-3 py-3 text-center text-[10px] text-foreground/35">没有匹配的分支</div>
          )}
        </div>
      )}
    </div>
